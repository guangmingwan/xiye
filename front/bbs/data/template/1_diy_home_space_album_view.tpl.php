...
0
|| checktplrefresh('./template/default/home/space_album_view.htm', './template/default/home/space_header.htm', 1426230694, 'diy', './data/template/1_diy_home_space_album_view.tpl.php', './template/default', 'home/space_album_view')
|| checktplrefresh('./template/default/home/space_album_view.htm', './template/default/home/space_userabout.htm', 1426230694, 'diy', './data/template/1_diy_home_space_album_view.tpl.php', './template/default', 'home/space_album_view')
|| checktplrefresh('./template/default/home/space_album_view.htm', './template/default/common/header_common.htm', 1426230694, 'diy', './data/template/1_diy_home_space_album_view.tpl.php', './template/default', 'home/space_album_view')
|| checktplrefresh('./template/default/home/space_album_view.htm', './template/default/home/space_diy.htm', 1426230694, 'diy', './data/template/1_diy_home_space_album_view.tpl.php', './template/default', 'home/space_album_view')
|| checktplrefresh('./template/default/home/space_album_view.htm', './template/default/home/space_header_personalnv.htm', 1426230694, 'diy', './data/template/1_diy_home_space_album_view.tpl.php', './template/default', 'home/space_album_view')
;?>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=album&amp;id=<?php echo $album['albumid'];?>&amp;spaceuid=<?php echo $space['uid'];?>&amp;handlekey=sharealbumhk_<?php echo $album['albumid'];?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" class="oshr ofav">收藏</a>
<?php if(helper_access::check_module('share')) { ?><a href="home.php?mod=spacecp&amp;ac=share&amp;type=album&amp;id=<?php echo $album['albumid'];?>&amp;handlekey=sharealbumhk_<?php echo $album['albumid'];?>" id="a_share" onclick="showWindow(this.id, this.href, 'get', 0);" class="oshr">分享</a><?php } } ?>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['space_album_op_extra'])) echo $_G['setting']['pluginhooks']['space_album_op_extra'];?>
<?php if($space['self']) { ?><a href="<?php if($album['albumid'] > 0) { ?>home.php?mod=spacecp&ac=album&op=edit&albumid=<?php echo $album['albumid'];?><?php } else { ?>home.php?mod=spacecp&ac=album&op=editpic&albumid=0<?php } ?>">编辑</a><span class="pipe">|</span><?php } if(($_G['uid'] == $album['uid'] || checkperm('managealbum')) && $album['albumid'] > 0) { ?>
<a href="home.php?mod=spacecp&amp;ac=album&amp;op=delete&amp;albumid=<?php echo $album['albumid'];?>&amp;uid=<?php echo $album['uid'];?>&amp;handlekey=delalbumhk_<?php echo $album['albumid'];?>" id="album_delete_<?php echo $album['albumid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">删除</a><span class="pipe">|</span>
<?php } if($_G['uid'] != $album['uid']) { ?>
<a href="javascript:;" onclick="showWindow('miscreport<?php echo $album['albumid'];?>', 'misc.php?mod=report&rtype=album&uid=<?php echo $album['uid'];?>&rid=<?php echo $album['albumid'];?>', 'get', -1);return false;">举报</a><span class="pipe">|</span>
<?php } ?>
</div>
...
<?php if($albumlist) { if(is_array($albumlist)) foreach($albumlist as $key => $albums) { ?><ul id="albumbox_<?php echo $key;?>" class="ptm ml z" <?php if(!isset($albums[$id]) && !($key==0 && $id<0)) { ?> style="display: none;"<?php } else { $nowalbum=$key;?><?php } ?>><?php if(is_array($albums)) foreach($albums as $akey => $value) { $pwdkey = 'view_pwd_album_'.$value['albumid'];?><li style="width: 136px;">
<div class="c">
