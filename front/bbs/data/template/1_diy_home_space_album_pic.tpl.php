...
0
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/home/space_header.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/common/seccheck.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/home/space_userabout.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/common/header_common.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/home/space_diy.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
|| checktplrefresh('./template/default/home/space_album_pic.htm', './template/default/home/space_header_personalnv.htm', 1426164372, 'diy', './data/template/1_diy_home_space_album_pic.tpl.php', './template/default', 'home/space_album_pic')
;?>
<?php $_G['home_tpl_titles'] = array(getstr($pic['title'], 60, 0, 0, 0, -1), $album['albumname'], '相册');?><?php $friendsname = array(1 => '仅好友可见',2 => '指定好友可见',3 => '仅自己可见',4 => '凭密码可见');?><?php if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="d bbs">
<p id="a_set_title" class="albim_pic_title"><?php if($pic['title']) { ?><?php echo $pic['title'];?><?php } else { echo substr($pic['filename'], 0, strrpos($pic['filename'], '.'));?><?php } if($pic['status'] == 1) { ?><b>(待审核)</b><?php } ?></p>
<p class="xg1 xs1">
